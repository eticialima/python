"""
45) Leia duas matrizes 4 x 4 e escreva uma terceira com os maiores
...
for i in range(4):
    ...
    for j in range(4):
        num = int(input("Enter a value for the first array: "))
        lista2.append(num)
...
for i in range(4):
    ...
    for j in range(4):
        num = int(input("Enter a value for the second array: "))
        lista3.append(num)
