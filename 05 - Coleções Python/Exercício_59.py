"""
59) Faça um programa que leia uma matriz 3 x 6 com valores reais.
...
for i in range(3):
    ...
    for j in range(6):
        elemento = float(input("Enter a number: "))
...
print(f"\nSum of odd column elements: {soma_impares}")
...
print(f"Arithmetic mean of columns 2 and 4: {sum(media_aritmetica) / len(media_aritmetica)}\n")
